        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          ...
          <div>
            ...
            <p className="text-gray-700 mb-4">
              OM.TLLC provides comprehensive road freight solutions across North America and Europe. Our extensive network of trusted carriers and advanced logistics management ensures your cargo reaches its destination safely and on time.
            </p>
            <p className="text-gray-700 mb-4">
