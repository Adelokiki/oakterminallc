        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-20">
          <div>
            ...
            <p className="text-gray-700 mb-4">
              OM.TLLC offers universal services for the transport of goods by rail throughout the USA in trains (including baggage cars), gondola cars, and ISO containers. We also work with railway operators to provide access to the USA and Europe by rail for companies and producers in Europe.
            </p>
            <p className="text-gray-700">
              Rail transport can be ordered as a separate service or integrated into the multimodal supply chain. The long-term relationships and direct contracts with European railway structures enable OM.TLLC to exercise the advantages of the first forwarder and to make competitive offers for rail freight from the USA to European countries.
            </p>
          </div>
          <div>
            <img 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-20">
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <p className="text-gray-600">
              OM.TLLC Logistics offers inland rail transport services in the USA and Europe, based on its extensive worldwide networks. OM.TLLC Logistics also offers high-quality services and competitive prices based on the know-how it has built for years.
            </p>
          </div>
          <div className="bg-white rounded-lg shadow-lg p-8">
