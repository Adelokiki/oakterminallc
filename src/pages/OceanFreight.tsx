  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div 
        ...
        style={{
          minHeight: "80vh",
          backgroundImage: "url('/oak-terminal-4.png.jpg')",
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          ...
          <div>
            ...
            <p className="text-gray-700 mb-4">
              Oakmar Terminal is one of the largest global freight forwarders operating within a worldwide network. Tailor-made solutions for your specific ocean freight requirements form the core of our services.
            </p>
            <p className="text-gray-700 mb-4">
            ...
            <p className="text-gray-700">
              Oakmar Terminal can offer a flexible range of ocean freight and ocean freight services for both Less-than-Container Load (LCL) and Full-Container Load (FCL) shipments. These are supported by extensive sea and ocean freight management services and breakbulk, project forwarding, partial, and full charter services.
            </p>
          </div>
        </div>
