        ...
        >
          ...
          <div className="container relative mx-auto px-4 text-center">
            ...
            <p className="text-xl text-gray-200 max-w-2xl mx-auto">
              Get in touch with our team for inquiries about our MIKKY shipping services
            </p>
          </div>
        </div>
      </div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className={mutedTextColor}>info@mikky.com</p>
                  <p className={mutedTextColor}>support@mikky.com</p>
                </div>
              </div>
